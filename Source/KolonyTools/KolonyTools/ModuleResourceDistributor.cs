...
{
    public class ModuleResourceWarehouse : PartModule
    {
    ...
    public class ModuleResourceDistributor : PartModule
    {
        ...
        public override void OnFixedUpdate()
        {
            if (part.Resources.Contains(BrokeredResource) && part.protoModuleCrew.Count == part.CrewCapacity)
            {
                ...
                var whpList = vessel.parts.Where(p => p.Modules.Contains("ModuleResourceWarehouse"));
                ...
                foreach (var p in vessel.parts.Where(vp => vp != part && !vp.Modules.Contains("ModuleResourceWarehouse")))
                {
